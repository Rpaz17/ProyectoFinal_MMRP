...
public class Personajes {
    ...
    public static ArrayList<Personajes> getCartasMazo() {
        ...
        Cartas_Mazo.add(new Personajes("Treboles_6", 46, false, null));
        Cartas_Mazo.add(new Personajes("Treboles_5", 45, false, null));
        Cartas_Mazo.add(new Personajes("Treboles_4", 44, false, null));
        Cartas_Mazo.add(new Personajes("Treboles_3", 43, false, null));
        Cartas_Mazo.add(new Personajes("Treboles_2", 42, false, null));
        Cartas_Mazo.add(new Personajes("Corazones_A", 21, false, null));
        Cartas_Mazo.add(new Personajes("Corazones_K", 123, false, null));
        Cartas_Mazo.add(new Personajes("Corazones_Q", 122, false, null));
        Cartas_Mazo.add(new Personajes("Corazones_10", 30, false, null));
        Cartas_Mazo.add(new Personajes("Picas_10", 10, false, null));

        Cartas_Mazo.add(new Personajes("Treboles_7", 47, false, null));
        Cartas_Mazo.add(new Personajes("Picas_A", 1, false, null));
        Cartas_Mazo.add(new Personajes("Diamantes_2", 32, false, null));
        Cartas_Mazo.add(new Personajes("Diamantes_3", 30, false, null));
        Cartas_Mazo.add(new Personajes("Diamantes_4", 30, false, null));
        Cartas_Mazo.add(new Personajes("Diamantes_5", 30, false, null));
        Cartas_Mazo.add(new Personajes("Diamantes_6", 30, false, null));
        Cartas_Mazo.add(new Personajes("Diamantes_7", 30, false, null));
        Cartas_Mazo.add(new Personajes("Corazones_9", 29, false, null));
        Cartas_Mazo.add(new Personajes("Picas_Q", 122, false, null));

        Cartas_Mazo.add(new Personajes("Treboles_8", 48, false, null));
        ...
        Cartas_Mazo.add(new Personajes("Treboles_3", 43, false, null));
        Cartas_Mazo.add(new Personajes("Treboles_2", 42, false, null));
        Cartas_Mazo.add(new Personajes("Diamantes_8", 38, false, null));
        Cartas_Mazo.add(new Personajes("Corazones_8", 28, false, null));
        Cartas_Mazo.add(new Personajes("Picas_R", 113, false, null));

        Cartas_Mazo.add(new Personajes("Treboles_9", 49, false, null));
        Cartas_Mazo.add(new Personajes("Picas_Q", 112, false, null));
        Cartas_Mazo.add(new Personajes("Treboles_7", 47, false, null));
        Cartas_Mazo.add(new Personajes("Corazones_6", 26, false, null));
        Cartas_Mazo.add(new Personajes("Corazones_5", 25, false, null));
        Cartas_Mazo.add(new Personajes("Corazones_4", 24, false, null));
        Cartas_Mazo.add(new Personajes("Corazones_A", 21, false, null));
        Cartas_Mazo.add(new Personajes("Diamantes_9", 39, false, null));
        Cartas_Mazo.add(new Personajes("Corazones_7", 27, false, null));
        Cartas_Mazo.add(new Personajes("Picas_A", 1, false, null));
        ...
        Cartas_Mazo.add(new Personajes("Treboles_8", 48, false, null));
        Cartas_Mazo.add(new Personajes("Corazones_7", 27, false, null));
        Cartas_Mazo.add(new Personajes("Corazones_2", 22, false, null));
        Cartas_Mazo.add(new Personajes("Corazones_3", 23, false, null));
        Cartas_Mazo.add(new Personajes("Corazones_K", 123, false, null));
        ...
        Cartas_Mazo.add(new Personajes("Corazones_5", 25, false, null));
        Cartas_Mazo.add(new Personajes("Diamantes_3", 33, false, null));
        ...
        Cartas_Mazo.add(new Personajes("Treboles_Q", 142, false, null));
        Cartas_Mazo.add(new Personajes("Treboles_K", 143, false, null));
        Cartas_Mazo.add(new Personajes("Treboles_A", 41, false, null));
        Cartas_Mazo.add(new Personajes("Diamantes_A", 31, false, null));
        Cartas_Mazo.add(new Personajes("Diamantes_K", 133, false, null));
        Cartas_Mazo.add(new Personajes("Corazones_4", 24, false, null));
        Cartas_Mazo.add(new Personajes("Diamantes_4", 34, false, null));
        ...
        Cartas_Mazo.add(new Personajes("Corazones_2", 22, false, null));
        Cartas_Mazo.add(new Personajes("Corazones_3", 23, false, null));
        Cartas_Mazo.add(new Personajes("Diamantes_5", 35, false, null));
        ...
        Cartas_Mazo.add(new Personajes("Diamantes_9", 39, false, null));
        Cartas_Mazo.add(new Personajes("Diamantes_8", 38, false, null));
        Cartas_Mazo.add(new Personajes("Diamantes_7", 37, false, null));
        Cartas_Mazo.add(new Personajes("Diamantes_6", 36, false, null));
